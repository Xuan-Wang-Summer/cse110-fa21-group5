...
function activateSpeechBtn() {
	...
	speechBtn.addEventListener('click', function () {
		...
		OutputMsg.text = "Hello! Speech recognition service can help you get instructions step by step without touching your phones. Say, Next, to start instructions or move to the next step. Say, Repeat, to let me repeat what I said. Say, Back, to move to previous step, Say, Stop. to end the speech service.";
